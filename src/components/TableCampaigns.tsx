        ...
        <Table className={classes.table} size="small" aria-label="a dense table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Offer in archive</TableCell>
          ...
          <TableBody>
            {rows.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell align="right">{row.offerArchive}</TableCell>
                ...
                <TableCell align="right">
                  <div className="row-center">
                    ...
                    {userId === row.userId ? (
                      <IconButton title="Delete campaign" onClick={handleDelete(row.title, row.id)}>
